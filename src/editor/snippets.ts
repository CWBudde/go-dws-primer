...
export const dwscriptSnippets = [
  ...
  },
  {
    label: "if",
    kind: "snippet",
    insertText: ["if ${1:condition} then", "begin", "  ${0}", "end;"].join(
      "\n",
    ),
    insertTextRules: 4,
  ...
  },
  {
    label: "while",
    kind: "snippet",
    insertText: ["while ${1:condition} do", "begin", "  ${0}", "end;"].join(
      "\n",
    ),
    insertTextRules: 4,
  ...
  },
  {
    label: "repeat",
    kind: "snippet",
    insertText: ["repeat", "  ${0}", "until ${1:condition};"].join("\n"),
    insertTextRules: 4,
  ...
  },
  {
    label: "tryfinally",
    kind: "snippet",
    insertText: ["try", "  ${1}", "finally", "  ${0}", "end;"].join("\n"),
    insertTextRules: 4,
